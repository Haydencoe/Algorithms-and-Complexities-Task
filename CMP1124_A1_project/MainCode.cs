...
namespace AlgorithmAss1
{
    class AlgorithmMain
    {
        ...
        private void initialiseSystem()
        {
            ...
            progConsole.setConsoleSize(120, 45);
        ...
        private List<StoredData> loadSharesData()
        {
            ...
            for (int _index = 0; _index < _strDay.Count(); _index++)
            {
                ...
                StoredData dataIn = new StoredData(_strDay[_index], dateOfTx, double.Parse(_strOpen[_index]), double.Parse(_strClose[_index]), double.Parse(_strDifference[_index]), Int32.Parse(_strVolume[_index]));
        ...
        private void displaySingleArray(List<StoredData> dataToDisplay)
        {
            ...
            for (int index = 0; index < dataToDisplay.Count(); index++)
            {
                ...
                openValue = dataToDisplay[index].Sh_open.ToString();
                closeValue = dataToDisplay[index].Sh_close.ToString();
                diffValue = dataToDisplay[index].Sh_diff.ToString();
                volumeValue = dataToDisplay[index].Sh_volume.ToString();
        ...
        private void displayDoubleSortArray(List<StoredData> firstDataToDisplay, List<StoredData> secondDataToDisplay)
        {
            ...
            for (int index = 0; index < totalLines / 2; index++) //show leftHandValue top elements
            {
                ...
                openValue1 = firstDataToDisplay[index].Sh_open.ToString();
                closeValue1 = firstDataToDisplay[index].Sh_close.ToString();
                diffValue1 = firstDataToDisplay[index].Sh_diff.ToString();
                volumeValue1 = firstDataToDisplay[index].Sh_volume.ToString();
                //-------------------------------------------------------------
                theDay2 = secondDataToDisplay[index].TxDay;
                theDate2 = secondDataToDisplay[index].TxDate.ToShortDateString();
                openValue2 = secondDataToDisplay[index].Sh_open.ToString();
                closeValue2 = secondDataToDisplay[index].Sh_close.ToString();
                diffValue2 = secondDataToDisplay[index].Sh_diff.ToString();
                volumeValue2 = secondDataToDisplay[index].Sh_volume.ToString();
                //-------------------------------------------------------------
            ...
            for (int index = 0; index < totalLines / 2; index++) //show bottom elements
            {
                ...
                openValue1 = firstDataToDisplay[index + initialLastSetCount].Sh_open.ToString();
                closeValue1 = firstDataToDisplay[index + initialLastSetCount].Sh_close.ToString();
                diffValue1 = firstDataToDisplay[index + initialLastSetCount].Sh_diff.ToString();
                volumeValue1 = firstDataToDisplay[index + initialLastSetCount].Sh_volume.ToString();
                ...
                openValue2 = secondDataToDisplay[index + secondLastSetCount].Sh_open.ToString();
                closeValue2 = secondDataToDisplay[index + secondLastSetCount].Sh_close.ToString();
                diffValue2 = secondDataToDisplay[index + secondLastSetCount].Sh_diff.ToString();
                volumeValue2 = secondDataToDisplay[index + secondLastSetCount].Sh_volume.ToString();
                //-------------------------------------------------------------
        ...
        private void displayDoubleSearchArray(List<StoredData> firstDataToDisplay, List<StoredData> secondDataToDisplay)
        {
            ...
            int loops;
            /********************/
            if (firstDataToDisplay.Count() >= secondDataToDisplay.Count())
            {
                loops = firstDataToDisplay.Count();
            }
            else
            {
                loops = secondDataToDisplay.Count();
            }
            for (int i = loops - 1; i >= 0; i--)
            {
                if (firstDataToDisplay.Count() > i)
                {
                    theDay1 = firstDataToDisplay[i].TxDay;
                    theDate1 = firstDataToDisplay[i].TxDate.ToShortDateString();
                    openValue1 = firstDataToDisplay[i].Sh_open.ToString();
                    closeValue1 = firstDataToDisplay[i].Sh_close.ToString();
                    diffValue1 = firstDataToDisplay[i].Sh_diff.ToString();
                    volumeValue1 = firstDataToDisplay[i].Sh_volume.ToString();
                }
                else
                {
                    openValue1 = "-";
                ...
                //-------------------------------------------------------------
                if (secondDataToDisplay.Count() > i)
                {
                    theDay2 = secondDataToDisplay[i].TxDay;
                    theDate2 = secondDataToDisplay[i].TxDate.ToShortDateString();
                    openValue2 = secondDataToDisplay[i].Sh_open.ToString();
                    closeValue2 = secondDataToDisplay[i].Sh_close.ToString();
                    diffValue2 = secondDataToDisplay[i].Sh_diff.ToString();
                    volumeValue2 = secondDataToDisplay[i].Sh_volume.ToString();
                }
                else
                {
                    openValue2 = "-";
            ...
            Console.WriteLine(firstDataToDisplay[0].SearchTypeAndTime + " || " + secondDataToDisplay[0].SearchTypeAndTime);
            string left = "This used " + firstDataToDisplay[0].CountRepetitions.ToString() + " iterations";
            string leftStr = _showTextWithTab(left, 100, ' ');
            string right = "This used " + secondDataToDisplay[0].CountRepetitions.ToString() + " iterations";
            string rightStr = _showTextWithTab(right, 100, ' ');
            //Console.WriteLine(" This used " + firstDataToDisplay[0].CountRepetitions.ToString() + " iteratio
